<div class="black-bg d-flex flex-column justify-content-between" style="width: 10%; height: 100vh; position: fixed; top: 0; left: 0;">
    <div>
        ...
        <div class="nav flex-column mt-4 text-start" style="margin-left: 20px;">
            <a class="link mt-2" href="admin_index.php">แดชบอร์ด</a>
            <a class="link mt-2" href="admin_media.php">มีเดีย</a>
            <a class="link mt-2" href="admin_package.php">แพ็คเกจ</a>
            <a class="link mt-2" href="admin_user.php">ผู้ใช้</a>
        </div>
    </div>
