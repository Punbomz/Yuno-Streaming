  ...
  <div class="w-100">
    ...
    <div class="container d-flex justify-content-center align-items-center flex-column" style="min-height: 80vh;">
      ...
      <form action="login_check.php" method="post">
        ...
        <div class="row justify-content-center">
          <button class="btn btn-warning" style="width: 428px;">เข้าสู่ระบบ</button>
        </div>
      </form>

      <div class="row justify-content-center mt-4">
        <div class="d-flex justify-content-between align-items-center" style="width: 450px;">
          <a href="forgot_password.php" class="m-2 text-decoration-none text-white">ลืมรหัสผ่าน?</a>
          <a href="register.php" class="btn btn-secondary m-2 text-black" style="width: 150px; background-color: white;">สมัครสมาชิก</a>
        </div>
      </div>
